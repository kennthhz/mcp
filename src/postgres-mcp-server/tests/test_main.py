...
class TestMain:
    ...
    @patch('awslabs.postgres_mcp_server.server.mcp.run')
    @patch('sys.argv', ['awslabs.postgres-mcp-server'])
    ...
    @patch('awslabs.postgres_mcp_server.server.mcp.run')
    @patch('sys.argv', ['awslabs.postgres-mcp-server', '--sse', '--port', '9999'])
    ...
    def test_module_execution(self):
        ...
        import inspect
        from awslabs.postgres_mcp_server import server
